...
import { Link } from 'react-router-dom'; // Import Link to navigate to admin panel
import './UserProfile.css';
import Sidebar from '../Sidebar/Sidebar';
import bannerImage from '../Home/Images/Frame 148 (1).png';
import TopNavigation from '../Navigation/TopNavigation';
import Footer from '../Footer/Footer';
import defaultProfileImage from '../Main/Images/user-128.png'; 
  ...
  return (
    <div className="main-container">
      ...
      <div className={`content ${isDarkMode ? 'dark' : 'light'}`} >
        ...
        {/* Display admin panel button if the email matches */}
        {user.email === 'spotify.sstep@gmail.com' && (
